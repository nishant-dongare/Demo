  ...
  if (temp === false) {
    if (formText[pos].value == "") {
      ...
      if (arr[pos - 1].test(formText[pos].value)) {
        ...
        textFields[pos].style.border = "1px solid rgb(207, 207, 207)";
      } else {
...
submitButton[0].onclick = function(){
  if(formText[1].value == '' || formText[2].value == '' || formText[4].value == ''){
    alert('Please fill the form first!!')
  }
  else{
    alert('Your grievance has been recorded, Thank You for your feedback..');
  }
}
